...
import getData from 'services/campaigns-manager/getProductsCategories';
import transformer from 'services/campaigns-manager/transformers/categoriesToSelectOptions';

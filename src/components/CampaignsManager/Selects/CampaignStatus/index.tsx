...
import getData from 'services/campaignsManager/getCampaignStatus';
import transformer from 'services/campaignsManager/transformers/campaignStatusToSelectOptions';

...
import getData from 'services/campaigns-manager/getCampaignStatus';
import transformer from 'services/campaigns-manager/transformers/campaignStatusToSelectOptions';

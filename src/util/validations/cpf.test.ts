...
describe('src/util/validations/cpf', () => {
  ...
  test(`isValidCpf('asdk19ld') should return false`, () => {
    expect(isValidCpf('asdk19ld')).to.be.false;
  });

  test(`isValidCpf(CORRECT_CPF) should return true`, () => {
  ...
  test(`isValidCpf(INCORRECT_CPF) should return false`, () => {
    expect(isValidCpf(INCORRECT_CPF)).to.be.false;
  });

  test(`isValidCpf('097.884.719-94') should return true`, () => {

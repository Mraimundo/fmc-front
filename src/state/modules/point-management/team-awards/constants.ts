...
export const SELECT_SUBSIDIARY =
  '@fmc/point-management/team-awards/SELECT_SUBSIDIARY';

export const SELECT_ROLE = '@fmc/point-management/team-awards/SELECT_ROLE';

export const SET_PARTICIPANT_FINDER =
  '@fmc/point-management/team-awards/SET_PARTICIPANT_FINDER';

export const SET_POINTS_TO_DISTRIBUTE =

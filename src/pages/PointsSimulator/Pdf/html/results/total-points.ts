...
export default (props: Props) => {
  ...
  const { totalAdditionalMargin, totalRebate, totalSeller } = award;

  const formattedRebate = format(totalRebate, 0, 0);
  const formattedAdditional = format(totalAdditionalMargin, 0, 0);
  const formattedSeller = format(totalSeller, 0, 0);
  ...
  <table id="u_content_html_28" class="u_content_html" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
